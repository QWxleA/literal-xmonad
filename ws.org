...
* src/MyKeys.hs [0/2]
  ...
  #+begin_src haskell -n
        ...
        subKeys "My Scripts"
        [ ("M3-p M-p",                 addName "Edit scripts"           $ menuEditScript)
        , ("M3-p M-e",                 addName "Edit configs"           $ menuEditConfig)
        , ("M3-p M-c",                 addName "Change colourscheme"    $ menuChangeColourscheme)
        , ("M3-p M-z",                 addName "Read PDF file"          $ menuReadPdf)
        ] ^++^
