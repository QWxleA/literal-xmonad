...
manageSpecific = composeAll . concat $
    ...
    -- , [ className  =? "zoom" <&&> titleContains z --> doFloatAt' (100/1920) (30/1040) | z <- ["Zoom - Free Account"] ]
    -- , [ resource   =? "zoom" <&&> titleContains z  --> doRectFloat (W.RationalRect (1/1920)(30/1040)(1/3)(9/10)) | z <- ["Zoom - Free Account"] ]
    -- , [ resource   =? "gsimplecal"                --> customFloating $ W.RationalRect 0.3 0.3 0.3 0.3 ]
