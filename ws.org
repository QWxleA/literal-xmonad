...
#+title: Literal XMonad - and support
#+date: <2020-12-24 Thu>
...
* src/MyKeys.hs
  ...
  - [[https://hackage.haskell.org/package/xmonad-contrib-0.16/docs/XMonad-Layout-MultiToggle-Instances.html][XMonad.Layout.MultiToggle.Instances]], key bindings for [[https://hackage.haskell.org/package/xmonad-contrib-0.16/docs/XMonad-Layout-MultiToggle.html][XMonad.Layout.MultiToggle]]:
    ...
    - =NBFULL=       Switch to Full with no borders (=Super-f=)
  ...
  #+begin_src haskell -n
        ...
        , ("M3-<Tab>"     , addName "toggle last workspace"       $ toggleWS)
        , ("M-S-<Left>"   , addName "Shift to next workspace"     $ shiftToNext >> prevWS)
        , ("M-S-<Right>"  , addName "Shift to previous workspace" $ shiftToNext >> nextWS)
        ]) ^++^
...
#+end_src
  ...
  [[https://hackage.haskell.org/package/xmonad-contrib-0.16/docs/XMonad-Layout-ShowWName.html][ShowName]]: This is a layout modifier that will show the workspace name (on entering a workspace). Especially usefull as I don't write workspace names in my bar. The workspace name is a project, defined under [[*src/MyWorkspaces][src/MyWorkspaces]].
